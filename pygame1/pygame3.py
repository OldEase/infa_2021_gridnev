...
def ghost_head(screen_for_place, proportion_x, proportion_y, color):
    pygame.draw.ellipse(
        screen_for_place,
        color,
        (
...
def ghost_body(place, color, proportion_x, proportion_y):
    pygame.draw.polygon(
        place,
        color,
        [
...
def ghost_orient(place, proportion_x, proportion_y, color_eye, side):
...
def ghost(screen_for_place, x_coordinate, y_coordinate, start_proportion_x, start_proportion_y, side, color_body,
          color_eye):  # призрак side выбирает направление взгляда :1 налево, 0 направо
...
def house(screen_for_place, x_start, y_start, x_size, y_size):  # отрисовка дома
    pygame.draw.rect(
        screen_for_place,
        (70, 0, 0),
        (
...
house(screen, 140, 150, 100, 140)
house(screen, 10, 300, 170, 220)
house(screen, 310, 180, 120, 160)
ghost(screen, 30, 430, 90, 140, 0, (255, 255, 255, 160), (230, 0, 0, 200))
ghost(screen, 190, 260, 80, 120, 0, (0, 200, 100, 160), (230, 0, 0, 200))
ghost(screen, 150, 300, 80, 120, 1, (0, 200, 100, 160), (230, 0, 0, 200))
ghost(screen, 250, 200, 40, 70, 1, (0, 200, 100, 160), (230, 0, 0, 200))
ghost(screen, 100, 150, 40, 70, 0, (0, 200, 100, 160), (230, 0, 0, 200))
ghost(screen, 200, 300, 400, 600, 1, (0, 200, 100, 160), (230, 0, 0, 200))
